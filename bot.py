            ...
            if chat.get("type") == "private":
                ...
                if command == "/start":
                    ...
                    safe_say(
                        ...
                        "Присылаю всю 4-ю страницу документа "
                        "при её изменении.\n"
                        "Проверки — примерно раз в 15 минут, "
                        "возможны задержки.\n\n"
                        "/schedule — получить расписание повторно\n"
                        "/stop — отписаться\n\n"
                        "Для рассылки сохраняется ваш Telegram ID. "
                        "Команда /stop удаляет его из текущего "
                        "списка подписчиков.",
                    )
...
def broadcast(state, png):
    ...
    for chat_id, subscriber in list(
        ...
        data = {
            "chat_id": chat_id,
            "caption": (
                "Расписание 10Б — 4-я страница документа.\n"
                "Последняя обнаруженная версия.\n\n"
